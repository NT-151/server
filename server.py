...
# loads a sentiment synset to catch synset which is words that have more than one meaning
...
def llm_analysis(name):
    ...
    response = llm.invoke(
        ...
        f"as detailed in {page_content_of_articles}, and incorporating sentiment analysis through a FinBERT machine learning model as"
        f"demonstrated in {sentimental}, you are tasked with forecasting the direction of {name} stocks' movement."
